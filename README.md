...
|[Fan-store](https://elena-myone.github.io/fan-store) | TypeScript, HTML, SASS(SCSS),  React, Redux, React Router DOM, Tailwind CSS, Node.js, Express, Axios | [Front-end code](https://github.com/Elena-MyOne/fan-store), [Back-end code](https://github.com/Elena-MyOne/fan-store-backend) Backend hosted on a free service with 20-minute inactivity idle mode, causing 2-3 minute delays for initial 200 responses|
...
| [Christmas-shop](https://elena-myone.github.io/christmas-shop/christmas-shop/) | JavaScript, HTML, CSS/SCSS | [code](https://github.com/Elena-MyOne/christmas-shop/tree/christmas-shop/christmas-shop)  |
